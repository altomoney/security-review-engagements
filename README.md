...
| December 2025 | Cantina | Oracles, DUSD & vesting | ERC-4626 ratio, Chainlink, Curve, Uniswap, multi-Chainlink, and rewards oracles; `DUSD`; `AltoVesting`. `AltoLeverageSwapper` was excluded.<br>Reviewed version: [`2cae67d9`](https://github.com/altomoney/v1/tree/2cae67d9) | [📄 View Report](./reports/report-cantinacode-alto-money-solo-1204.pdf) |
